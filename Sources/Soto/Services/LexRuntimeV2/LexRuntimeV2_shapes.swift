...
extension LexRuntimeV2 {
    ...
    public struct PutSessionResponse: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(audioStream: AWSHTTPBody? = nil, contentType: String? = nil, messages: String? = nil, requestAttributes: String? = nil, sessionId: String? = nil, sessionState: String? = nil) {
    ...
    public struct RecognizeUtteranceResponse: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(audioStream: AWSHTTPBody? = nil, contentType: String? = nil, inputMode: String? = nil, inputTranscript: String? = nil, interpretations: String? = nil, messages: String? = nil, recognizedBotMember: String? = nil, requestAttributes: String? = nil, sessionId: String? = nil, sessionState: String? = nil) {
            self.audioStream = audioStream
            self.contentType = contentType
            self.inputMode = inputMode
