...
extension BackupStorage {
    ...
    public struct GetObjectMetadataOutput: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(metadataBlob: AWSHTTPBody? = nil, metadataBlobChecksum: String? = nil, metadataBlobChecksumAlgorithm: DataChecksumAlgorithm? = nil, metadataBlobLength: Int64? = nil, metadataString: String? = nil) {
