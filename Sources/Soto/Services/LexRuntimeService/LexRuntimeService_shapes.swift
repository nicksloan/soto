...
extension LexRuntimeService {
    ...
    public struct PutSessionResponse: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(activeContexts: String? = nil, audioStream: AWSHTTPBody? = nil, contentType: String? = nil, dialogState: DialogState? = nil, encodedMessage: String? = nil, intentName: String? = nil, messageFormat: MessageFormatType? = nil, sessionAttributes: String? = nil, sessionId: String? = nil, slots: String? = nil, slotToElicit: String? = nil) {
            self.activeContexts = activeContexts
            self.audioStream = audioStream
            self.contentType = contentType
            self.dialogState = dialogState
