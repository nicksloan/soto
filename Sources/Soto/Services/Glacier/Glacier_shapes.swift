...
extension Glacier {
    ...
    public struct GetJobOutputOutput: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(acceptRanges: String? = nil, archiveDescription: String? = nil, body: AWSHTTPBody? = nil, checksum: String? = nil, contentRange: String? = nil, contentType: String? = nil, status: Int? = nil) {
