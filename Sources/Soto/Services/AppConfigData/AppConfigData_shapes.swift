...
extension AppConfigData {
    ...
    public struct GetLatestConfigurationResponse: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(configuration: AWSHTTPBody? = nil, contentType: String? = nil, nextPollConfigurationToken: String? = nil, nextPollIntervalInSeconds: Int? = nil, versionLabel: String? = nil) {
