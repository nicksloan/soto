...
extension AppConfig {
    ...
    public struct Configuration: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(configurationVersion: String? = nil, content: AWSHTTPBody? = nil, contentType: String? = nil) {
    ...
    public struct HostedConfigurationVersion: AWSDecodableShape & AWSShapeWithPayload {
        ...
        public init(applicationId: String? = nil, configurationProfileId: String? = nil, content: AWSHTTPBody? = nil, contentType: String? = nil, description: String? = nil, versionLabel: String? = nil, versionNumber: Int? = nil) {
            self.applicationId = applicationId
            self.configurationProfileId = configurationProfileId
            self.content = content
            self.contentType = contentType
